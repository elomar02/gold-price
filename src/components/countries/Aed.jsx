    ...
    <>
      <Grid container spacing={2}>
        <Grid item xs={12} md={6}>
          <List>
            <ListItem disablePadding>
              <ListItemText className="heading" primary="Gold price in Emirates " />
            </ListItem>
            {/* end box */}
            <ListItem disablePadding>
        ...
        <Grid item xs={12} md={4}>
          <List className='aedClass'>
          <ListItem disablePadding>
              <ListItemText className="heading" primary="Exchange 1 dirham " />
            </ListItem>
            {/* end box */}
             
            <ListItem disablePadding>
              <ListItemText primary={(1 / USDAED).toFixed(3)} />
              <ListItemText primary="dollar" />
            </ListItem>
            <ListItem disablePadding>
              <ListItemText primary={(USDEGP / USDAED ).toFixed(3)} />
              <ListItemText primary="Egyptian Pound" />
            </ListItem>
            <ListItem disablePadding>
              <ListItemText primary={(USDSAR / USDAED).toFixed(3)} />
              <ListItemText primary="Saudi riyal" />
            </ListItem>
            <ListItem disablePadding>
              <ListItemText primary={(USDTRY / USDAED).toFixed(3)} />
